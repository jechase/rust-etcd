...
pub struct WatchClient {
    grpc_client: ::grpc::Client,
    method_Watch: ::std::sync::Arc<::grpc::rt::MethodDescriptor<super::rpc::WatchRequest, super::rpc::WatchResponse>>,
}
...
impl WatchServer {
    pub fn new_service_def<H : Watch + 'static + Sync + Send + 'static>(handler: H) -> ::grpc::rt::ServerServiceDefinition {
        let handler_arc = ::std::sync::Arc::new(handler);
        ::grpc::rt::ServerServiceDefinition::new("/etcdserverpb.Watch",
            vec![
                ::grpc::rt::ServerMethod::new(
                    ::std::sync::Arc::new(::grpc::rt::MethodDescriptor {
                        name: "/etcdserverpb.Watch/Watch".to_string(),
                    ...
                    {
                        let handler_copy = handler_arc.clone();
                        ::grpc::rt::MethodHandlerBidi::new(move |o, p| handler_copy.watch(o, p))
                    },
                ),
            ],
        )
